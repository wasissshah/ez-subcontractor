...
const sidebarLinks = [
    ...
    { href: '/affiliate/my-subscription-old', text: 'My Subscription', icon: '/assets/img/icons/saved.svg' },
    { href: '/affiliate/transaction-history-old', text: 'Transaction History', icon: '/assets/img/icons/saved.svg' },
    { href: '/affiliate/saved-cards', text: 'Saved Cards', icon: '/assets/img/icons/saved.svg' },
];

export default function TransactionHistory() {
    const activePage = '/affiliate/transaction-history-old'; // Active page highlight
