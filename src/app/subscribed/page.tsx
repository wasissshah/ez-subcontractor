                                ...
                                <div className="range-wrapper mb-5">
                                    <div className="range-container">
                                        <div className="slider-wrap">
                                            <input type="range" min="0" max="100" defaultValue="2" className="range-slider" />
                            ...
                            <div className="col-xl-9">
                                ...
                                {jobs.map((job, index) => (
                                    <div key={index} className="posted-card posted-card-1 custom-card mb-3">
                                        ...
                                        <button className="see-more-btn d-block" onClick={() => toggleExpand(index)}>
