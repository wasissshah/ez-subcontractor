...
export default function HomePage() {
    ...
    const [pricingPlans, setPricingPlans] = useState<any[]>([]); // ✅ Pricing state
    ...
    // ✅ Fetch pricing plans (same as PricingPage)
    useEffect(() => {
    ...
    return (
        <div>
            ...
            <div className="sections overflow-hidden">
                ...
                {/* ✅ PRICING SECTION — ADDED AFTER FAQs */}
                <section className="hero-sec pricing-sec position-static">
                    <div className="container py-5">
                        <div className="text-center mb-5">
                            <h2 className="main-title fw-bold mb-3">Simple, Transparent Pricing</h2>
                            <p className="text-muted">Choose the plan that fits your business. No hidden fees. Cancel anytime.</p>
                        </div>
