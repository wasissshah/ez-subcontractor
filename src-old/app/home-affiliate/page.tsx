...
import '../../styles/pricing.css'; // ✅ Include pricing styles
...
export default function HomePage() {
    ...
    const [pricingPlans, setPricingPlans] = useState<any[]>([]); // ✅ New state
    const [pricingLoading, setPricingLoading] = useState(true); // ✅ Loading state

    // ✅ Fetch pricing plans from API (client-side only)
    useEffect(() => {
        const fetchPlans = async () => {
            try {
                ...
                // Skip if response is HTML (e.g., login redirect)
    ...
    // ✅ Note card component (reused from pricing page)
    ...
    const hasAnyActiveSubscription = pricingPlans.some(
        (p) => p.is_subscribed === true && p.status !== 'cancelled' && p.is_cancelled !== true
    );

    // ✅ Render individual plan card (matches your pricing page)
                    ...
                    <div className="pricing-header">
                        ...
                        {plan.showStrike ? (
                            <div className="d-flex align-items-center gap-1 flex-wrap">
                                <del className="fs-18 fw-medium text-black">
                                    $ {plan.price.toFixed(2)}
                                </del>
                                <div className="d-flex align-items-center gap-2">
                                    <span className="price">
                                        $<span className="fw-bold">
                                            {parseFloat(plan.discount_price).toFixed(2)}
                                        </span>
                                    </span>
                                    {plan.saveText && (
                                        <div
    ...
    return (
        <div>
            ...
            <div className="sections overflow-hidden">
                    ...
                    <div className="container">
                        <div className="text-center">
                            <div className="text-center mb-4">
                                ...
                                <p className="mb-0">
                                    We connect skilled general contractors with high-quality projects, reliable support, and streamlined workflows — so you can focus on building excellence. If you’re licensed, insured, and ready to scale, apply today to become a preferred contractor in our growing network.
                                </p>
                            </div>
                            <div className="text-center">
                                <Link
                                    href="#"
                                    className="btn btn-light bg-white text-center d-lg-block mx-auto"
                                    style={{ width: '300px' }}
                                >
                                    Join as General Contractor
                                </Link>
                            </div>
                        </div>
                    </div>
                ...
                {/* ✅ PRICING SECTION — INSERTED AFTER FAQ */}
                <section className="hero-sec pricing position-static">
                    <div className="container py-5">
                        <div className="text-center mb-5">
                            <h2 className="main-title fw-bold mb-3">Simple, Transparent Pricing</h2>
                        ...
                        {pricingLoading ? (
                            ...
                            <div className="text-center py-5">
                                ...
                                <Link href="/pricing" className="btn btn-primary mt-2">
                                    View All Plans
                                </Link>
                            </div>
                        )}
                        ...
                        <div className="row g-4">
                            <div className="col-lg-5">
                                <Image
                                    ...
                                    style={{ objectFit: 'cover', minHeight: '550px', borderRadius: '8px' }}
